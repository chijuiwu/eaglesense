...
namespace topviewkinect
{
    namespace vision
    {
        ...
        static const int NUM_FEATURES = FEATURE_NUM_LAYER_AREAS + FEATURE_NUM_LAYER_CONTOURS + FEATURE_NUM_LAYER_DISTANCES + FEATURE_NUM_INTRALAYER_POSITIONS + FEATURE_NUM_INTERLAYER_POSITIONS + FEATURE_NUM_BODY_EXTREMITIES + FEATURE_NUM_BODY_EXTREMITIES_INFRAREDS;
    }
}