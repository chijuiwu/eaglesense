...
namespace topviewkinect
{
    namespace vision
    {
        ...
        public:
            ...
            void output_skeleton_features(const int frame_id, const std::vector<topviewkinect::skeleton::Skeleton>& skeletons, const int dataset_label, const bool keep_label);
